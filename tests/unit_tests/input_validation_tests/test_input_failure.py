from src.utils.validation import input_failure
...
def test_supported_values():
    ...
    date = "30-12-2017"
    expected_result = []
    actual_result = input_failure(ars_quantity, crypto, date)
...
def test_unsupported_crypto_and_date():
    ars_quantity = 1000
    crypto = ""
    date = ""
...
def test_unsupported_present_date():
    ...
    expected_result = ["Date is not supported"]
    actual_result = input_failure(ars_quantity, crypto, present_date)
    assert expected_result == actual_result
...
def test_unsupported_future_date():
    ...
    expected_result = ["Date is not supported"]
    actual_result = input_failure(ars_quantity, crypto, tomorrow_date)
    assert expected_result == actual_result