...
async def test_supported_crypto_with_supported_date():
    ...
    expected_result = {
        ...
        "crypto_value_improvement_percentage": (crypto_actual_price * 100) / crypto_purchased_price,
        "verbose_evaluation" : "If you had 1000 Argentinian pesos in 30-12-2017 you could have bought " \
                               ...
                               "bitcoin investment would have been of " + str((crypto_actual_price * 100) / crypto_purchased_price) + " %"
